...
var count = 1; //var urlfield = '<textarea name="url_' + count + '" class="bg-gray-100 rounded border border-gray-400 leading-normal resize-none w-full h-20 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white"  placeholder="Enter your url"></textarea>';
